...
1. Look in the current workspace for a `CLAUDE.md` file.
...
5. **Check for active sprint:**
   - Use `find docs/sprints/ -name "*.active.md" -type f 2>/dev/null` to find active sprint files.
...
If the project or CLAUDE.md file is not found, inform the user and list what you see in the current directory.
